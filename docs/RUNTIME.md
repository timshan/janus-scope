...
本文件只說明 GitHub Issue #1 納入的 Windows x64 portable bootstrap。Desktop／Android Mobile 啟動與 client profile 請見 [`PROFILES.md`](PROFILES.md)；截圖操作請見 [`USAGE.md`](USAGE.md)，GUI 與 updater 尚未實作。
